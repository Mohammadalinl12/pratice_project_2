...
`;
const LandingSection =styled.div`${tw`w-full h-screen flex flex-col`}
...
const InfoSection = styled.div`
  ...
  `}
`
const FloatingText =styled.h1`${tw`
m-0
font-black
text-white
font-size[60px]
    ...
    <LandingSection>
      ...
      <InfoSection>
        ...
        <DescriptionText>
          ...
          <ViewMoreButton>
            <Link to="Explore" smooth={"easeInOutQuad"} duration={1500}><BsArrowDownCircle/></Link>
          </ViewMoreButton>
    </LandingSection>
  </TopSectionContainer>;
};
